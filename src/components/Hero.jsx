...
import heroVideo from '../assets/hero video/harshith-hero.mp4';
...
<div
  data-aos="fade-up"
  data-aos-delay="100"
  className="h-[70px] md:h-[90px] flex items-start"
>
  <TypeAnimation
    sequence={[
      "AI/ML Engineer",
    ...
    speed={45}
    repeat={Infinity}
    className="text-black font-black text-4xl md:text-5xl lg:text-6xl leading-tight"
    cursor={true}
  />
</div>
